...
""" },
    ...
    public static async Task SeedAchievementsAsync(AppDbContext db)
    {
        var definitions = new[]
        {
            ...
            new { Id = "streak_3",     Title = "Kiên trì",        Desc = "Học 3 ngày liên tiếp",          Icon = "🗓️", Type = "streakDays",  Value = 3,   Xp = 20 },
            ...
            new { Id = "social_1",     Title = "Kết nối",         Desc = "Theo dõi một người dùng",       Icon = "👥", Type = "followAny",   Value = 1,   Xp = 10 },
        };
